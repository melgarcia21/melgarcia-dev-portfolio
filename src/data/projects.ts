...
export interface Project {
  ...
  links: {
    /* Note: the actual preview link are not given yet, keep the placeholder */
    preview?: string;
  };
}
...
export const projects: Project[] = [
  {
    ...
    description:
      "A comprehensive SaaS dashboard for managing clients and subscriptions.",
    details:
      "This project was built from the ground up to provide a seamless user experience for business owners. It features real-time data visualization, secure authentication, and a fully responsive interface that works on all devices. The main challenge was to handle large datasets efficiently without compromising on performance.",
...

  {
    ...
    details:
      "This platform allows users to browse products, add them to a cart, and securely checkout. It includes an admin dashboard for managing inventory and orders. The project was optimized for SEO and performance to ensure a smooth shopping experience.",
...

  {
    ...
    details:
      "This app allows users to log their workouts, set fitness goals, and track progress over time. It includes features like push notifications, social sharing, and integration with wearable devices. The app was designed with a focus on user engagement and retention.",
  ...
  },
  {
    ...
    details:
      "This website was built to highlight my professional experience and projects. It includes a blog section, contact form, and animations for an engaging user experience. The site is fully responsive and optimized for fast loading times.",
  ...
  },
  {
    ...
    details:
      "This application helps users practice for job interviews by simulating real interview scenarios. It uses AI to generate questions and provide feedback on user responses. The app was designed to be user-friendly and accessible, with a focus on helping users improve their interview skills.",
  ...
  },
  {
    ...
    description:
      "An AI-powered web app that generates content based on user input.",
    details:
  ...
  },
  {
    ...
    description:
      "A cross-platform social media app for sharing photos and connecting with friends.",
    details:
      "This app allows users to create profiles, share photos, and connect with friends. It includes features like real-time notifications, direct messaging, and a news feed. The app was designed with a focus on performance and user experience, ensuring smooth navigation and fast loading times.",
  ...
  },
  {
    ...
    details:
      "This app helps users organize their tasks and to-do lists efficiently. It includes features like task categorization, due dates, and reminders. The app was designed to be intuitive and easy to use, with a clean and modern interface. It also includes collaboration features for sharing tasks with team members.",
  ...
  },
  {
    ...
    description:
      "A desktop application for managing inventory and stock levels.",
    details:
  ...
  },
  {
    ...
    category: "Web App",
    image: "/images/projects/project-10-hero.jpg",
    thumbnail: "/images/projects/project-10-thumb.jpg",
    video: "/videos/project-10-demo.mp4",
    techStack: ["Laravel", "React", "PostgreSQL", "PHP", "Tailwind CSS"],
    description:
      "A blogging platform similar to Medium, built with Laravel and React.",
    details:
      "This project is a full-featured blogging platform that allows users to create, edit, and publish articles. It includes features like user authentication, article categorization, and a rich text editor. The platform was designed to be user-friendly and visually appealing, with a focus on content creation and sharing.",
    links: {
      preview: "/projects/project-ten",
    },
  },
